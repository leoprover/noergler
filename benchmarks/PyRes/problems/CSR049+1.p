...
%------------------------------------------------------------------------------
% File     : CSR049+1 : TPTP v9.2.1. Released v3.4.0.
...
% Status   : Theorem
% Rating   : 0.00 v7.0.0, 0.25 v6.4.0, 0.00 v5.5.0, 0.11 v5.3.0, 0.09 v5.2.0, 0.00 v4.1.0, 0.11 v4.0.0, 0.10 v3.7.0, 0.00 v3.4.0
% Syntax   : Number of formulae    :  177 (  39 unt;   0 def)
...
%            Number of predicates  :   45 (  45 usr;   0 prp; 1-2 aty)
